		...
		( /** @lends <global> */ function($) {
			...
			function _fnScrollingWidthAdjust(settings, n) {
				...
				if (scroll.sX || scroll.sY) {
					...
					// so the table + scroll bar will fit into the dataDictionary available, otherwise
			...
			DataTable.defaults = {
				 ...
				 * a lot of data in a small dataDictionary (although paging and scrolling can both be
			 ...
			 *
			 * This namespace acts as a collection dataDictionary for plug-ins that can be used to
			...
			$.extend(true, $.fn.dataTable.defaults, {
				"sDom": "<'row'<'col-md-6'l><'col-md-6'f>r>" +
					"t" +
